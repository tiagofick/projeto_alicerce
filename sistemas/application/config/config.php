...
|
*/
$config['base_url'] = 'http://localhost/tiagofick/sistemas/';
...
|--------------------------------------------------------------------------
| Por default o codeigniter apenas lê as classes da pasta application/core iniciadas pelo prefixo "MY_"
| Então adicionamos a função abaixo que irá carregar todas as classes independentes de seu prefixo.
|
| Dessa forma posso customizar uma classe para cada sistema, desde que a mesma extenda a classe MY_Controller
|
